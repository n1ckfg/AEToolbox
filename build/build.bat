...
copy /b aetoolbox_main.js+aetoolbox_basic.js+aetoolbox_advanced.js+aetoolbox_rigging.js+aetoolbox_stereo.js+aetoolbox_guide.js+aetoolbox_export.js+aetoolbox_import.js+aetoolbox_util.js %BUILD_TARGET%
