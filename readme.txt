...
5. Bake Keyframes (layer selection): Bakes expressions and puppet pins to keyframes.
6. Make Loop...
...
7. Onion Skin (no selection): Creates an adjustment layer that applies an onion skin effect.

II.  RIGGING
1. Blink Control (comp selection): Turns a blink layer inside the comp on and off.  
2. Jaw Rig Side (comp selection): Rigs a jaw layer inside the comp for audio control.
3. Jaw Rig Front (comp selection): Rigs a jaw layer inside the comp for audio control.
4. Snake Rig (layer selection): Rigs a puppet-pin layer for automated snake-like movement.
